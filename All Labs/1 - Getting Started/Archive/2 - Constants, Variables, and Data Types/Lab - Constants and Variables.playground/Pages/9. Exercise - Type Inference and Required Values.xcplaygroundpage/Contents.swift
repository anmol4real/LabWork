...
var name: String
//print(name)
print("The code will not combine because name is not initialised")
...
//print("the code will not compile because distance traveled is initialised as an int and cannot handle decimal values")
