...
print("When double is used for division the result is more accurate than when integer is used due to floating point precision")
 ...
 */
let pi = 3.1415927 
let constantRadius: Double = 5.0
let diameter: Double = 2 * constantRadius
let circumference: Double = 2 * pi * constantRadius
...
let even = 10
let odd = 7
print("Remainder For even is \(even/2) and odd is \(odd/2)")
/*:
