...
var myUser = User(userName: "Tanmay", email: "xyz.example.com", age: 20)
myUser.printCurrentUserDetails()

User.currentUser = myUser
print("Adding a Currnt User")
myUser.printCurrentUserDetails()
 ...
 */
var anotherUser = User(userName: "Alice", email: "alice@example.com", age: 25)
User.currentUser?.logIn(user: anotherUser)
print("Adding a Currnt User")
myUser.printCurrentUserDetails()
/*:
