...
var favoriteBook = Book(title: "The Metamorphosis", author : "Franz Kafka" , pages : 67, price : 73  )
...
var firstLaptop = Laptop(yearPurchased: 2025)
var secondLaptop = Laptop(yearPurchased: 2024)
...
var firstPerson = Height(inches: 65)
print(firstPerson)

var secondPerson = Height(centimeters: 175)
print(secondPerson)
