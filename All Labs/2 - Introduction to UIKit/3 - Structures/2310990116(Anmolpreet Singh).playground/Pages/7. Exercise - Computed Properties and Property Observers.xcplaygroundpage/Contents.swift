...
var someRectangle = Rectangle(width: 10, height: 20)
print("Area: \(someRectangle.area)")
...
struct Height {
    var heightInInches: Double{
        didSet{
            print("The height is about to set to \(heightInInches) inches from \(oldValue)")
            var temp = heightInInches * 2.54
            if heightInCentimeters != temp
                {
    ...
    var heightInCentimeters: Double{
        didSet{
            print("The height is set to \(heightInCentimeters) cms")
...
print(" Height is \(myHeight.heightInInches) in and \(myHeight.heightInCentimeters) cms")

myHeight.heightInInches = 70
print(" Height is \(myHeight.heightInInches) in and \(myHeight.heightInCentimeters) cms")

myHeight.heightInCentimeters = 70
print(" Height is \(myHeight.heightInInches) in and \(myHeight.heightInCentimeters) cms")
