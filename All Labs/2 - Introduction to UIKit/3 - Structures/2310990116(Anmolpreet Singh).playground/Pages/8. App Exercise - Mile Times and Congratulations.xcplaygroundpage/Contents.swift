...
var myRun = RunningWorkout(distance: 100, time: 20, elevation: 1.2)
print("My Run is \(myRun.averageMileTime) minutes per mile")
...
print("The progress is \(mySteps.steps)/\(mySteps.goal)")
print("Taking a step...")
mySteps.takeStep()
print("The progress is \(mySteps.steps)/\(mySteps.goal)")
