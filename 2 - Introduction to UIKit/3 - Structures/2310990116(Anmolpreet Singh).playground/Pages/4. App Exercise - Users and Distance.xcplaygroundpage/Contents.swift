...
var tanmay = User(name: "Tanmay Kataria", age: 20, height: 178, weight: 68, activityLevel: 9)

print("User Description")
print("Name: \(tanmay.name)\nAge: \(tanmay.age)\nHeight: \(tanmay.height) cm\nWeight: \(tanmay.weight) kg\nActivity Level: \(tanmay.activityLevel)/10")
...
struct Distancce {
    ...
    init(feet : Double){
        ...
        self.centimeters = self.meters * 100
    }
    ...
    init(centimeters : Double){
        ...
        self.meters = centimeters / 100
        self.feet = meters / 3.28084
    }
}

//:  Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
var mile = Distancce(meters: 1600)
print("Feet: \(mile.feet)")

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var anotherDistance = Distancce(feet: 880)
print("Meters: \(anotherDistance.meters)")
print("Centimeters: \(anotherDistance.centimeters)")
