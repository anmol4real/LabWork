 ...
 */
let name = "Tanmay Kataria"
let age = 20
print("My name is \(name) and after my next birthday I will be \(age) years old.") // it should be ( age + 1 ) , but its written age, so I am going with age
