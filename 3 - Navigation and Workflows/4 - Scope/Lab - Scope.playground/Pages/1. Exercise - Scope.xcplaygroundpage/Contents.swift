...
//print("The value of foo is \(foo)")
print("The above print statement will produce a complie error as var foo's scope only extends to the end of the for loop.")
...
print("The above pront statements will complie as var x is declated in the global scope and therefore accessable to all functions.")
