...
print("The error I got was - Value of optional type 'Int?' must be unwrapped to a value of type 'Int'")
...
print(userAge)
print("userAge's value is nil because the string '34e' cannot be converted to an Int")
/*:
